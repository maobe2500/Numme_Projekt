...
[tVec, rVec, rPrimeVec, phiVec, phiPrimeVec] = RK4(H_star, T, a, h);
[~, LPI] = min(rVec);
...
for i = 1:length(hVec)
    h = hVec(i);
    [H_star, v0, L, tMin, rMin, phiMin] = ErrRaket(a, h);
    ansMtrx(i, 1:6) = [H_star, v0, L, tMin, rMin, phiMin];
end
